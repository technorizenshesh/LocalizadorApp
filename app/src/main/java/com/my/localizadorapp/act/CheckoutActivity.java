...
import com.my.localizadorapp.Utillllls.Json;
import com.my.localizadorapp.Utillllls.Notifications;
import com.my.localizadorapp.Utillllls.PaymentsUtil;
import com.my.localizadorapp.databinding.ActivityCheckoutBinding;
...
/*  private ActivityCheckoutBinding layoutBinding;
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    switch (requestCode) {
      ...
      case LOAD_PAYMENT_DATA_REQUEST_CODE:
        ...
        binding.googlePayButton.setClickable(true);
  ...
  private void displayGarment(JSONObject garment) throws JSONException {
    ...
    binding.detailDescription.setText(Html.fromHtml(
  ...
  public void requestPayment(View view) {
    ...
    binding.googlePayButton.setClickable(false);
