...
public class Constants {
  ...
  public static final String CURRENCY_CODE = "PEN";
   ...
   */
  public static final List<String> SHIPPING_SUPPORTED_COUNTRIES = Arrays.asList("PE", "GB");
  ...
  public static final HashMap<String, String> PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS =
      new HashMap<String, String>() {{
        ...
        put("gatewayMerchantId", "629388056480782152");
