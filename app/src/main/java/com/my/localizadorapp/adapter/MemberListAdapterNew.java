...
public class MemberListAdapterNew extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public MemberListAdapterNew(Context context, ArrayList<MemberListDataModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.itme_member_list_new, viewGroup, false);
